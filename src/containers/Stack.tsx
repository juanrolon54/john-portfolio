...
export default () => {
    ...
    return (
        <Deflected.left className={`gap-8 dark:text-white grid grid-cols-1 md:grid-cols-2 md:grid-flow-row`}>
            ...
            <AnimatePresence >
                <LayoutGroup >
                    {isSelected && <motion.div layout key={tech.name} layoutId={tech.name} className="aspect-video overflow-hidden backdrop-blur-xl inset-32 border-black border dark:border-white flex flex-col gap-4">
